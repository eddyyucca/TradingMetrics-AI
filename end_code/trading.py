...
def fetch_btc_data(interval="1m", limit=100):
    """Mengambil data BTC/USDT dari Binance"""
    try:
...
def main():
    ...
    while True:
        ...
        print("\nMenganalisis data...")
        df = fetch_btc_data(timeframes[choice], 100)
